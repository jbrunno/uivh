const {vhsysui} = require("@vhsys-ui/theme/plugin");
const {commonColors} = require("@vhsys-ui/theme/colors");
  ...
  theme: {
    extend: {
      ...
      typography: (theme) => ({
        DEFAULT: {
          css: {
            color: "hsl(var(--vhsysui-foreground))",
            maxWidth: "none",
            hr: {
              marginTop: "2em",
              marginBottom: "2em",
        ...
        dark: {
          css: {
            color: "hsl(var(--vhsysui-default-700))",
            strong: {
        ...
        neutral: {
          css: {
            "--tw-prose-body": "hsl(var(--vhsysui-default-700))",
            "--tw-prose-headings": "hsl(var(--vhsysui-foreground))",
            "--tw-prose-lead": "hsl(var(--vhsysui-default-600))",
            "--tw-prose-links": "hsl(var(--vhsysui-default-900))",
            "--tw-prose-bold": "hsl(var(--vhsysui-default-900))",
            "--tw-prose-counters": "hsl(var(--vhsysui-default-500))",
            "--tw-prose-bullets": "hsl(var(--vhsysui-default-300))",
            "--tw-prose-hr": "hsl(var(--vhsysui-default-200))",
            "--tw-prose-quotes": "hsl(var(--vhsysui-default-900))",
            "--tw-prose-quote-borders": "hsl(var(--vhsysui-default-200))",
            "--tw-prose-captions": "hsl(var(--vhsysui-default-500))",
            "--tw-prose-code": "hsl(var(--vhsysui-default-900))",
            "--tw-prose-pre-code": "hsl(var(--vhsysui-default-200))",
            "--tw-prose-pre-bg": "hsl(var(--vhsysui-default-800))",
            "--tw-prose-th-borders": "hsl(var(--vhsysui-default-300))",
            "--tw-prose-td-borders": "hsl(var(--vhsysui-default-200))",
            "--tw-prose-invert-body": "hsl(var(--vhsysui-default-300))",
            ...
            "--tw-prose-invert-pre-code": "hsl(var(--vhsysui-default-300))",
