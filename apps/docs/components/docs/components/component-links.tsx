import {Button, ButtonProps, Code, Link, Tooltip} from "@vhsys-ui/react";
import {ReactNode} from "react";
import Balancer from "react-wrap-balancer";

import {NpmIcon, AdobeIcon, StorybookIcon, NextJsIcon} from "@/components/icons";
...
export const ComponentLinks = ({
  ...
  return (
    <div className="flex flex-wrap gap-3 mt-6">
      <ButtonLink
        href={`https://storybook.vhsys.com.br/?path=/story/components-${
          storybook || component
        }--default`}
      ...
      <ButtonLink
        href={`https://www.npmjs.com/package/@vhsys-ui/${component}`}
