...
import {Button, ButtonProps, Kbd, Modal, ModalContent} from "@vhsys-ui/react";
          ...
          <Command.List ref={listRef} className={slots.list()} role="listbox">
                  ...
                  <div>
                    ...
                    {query.length === 1 ? (
                      <p className="text-default-400">
                        Tente adicionar mais caracteres ao seu termo de pesquisa.
                      </p>
                    ) : (
                      <p className="text-default-400">Tente procurar por outra coisa.</p>
                    )}
                  </div>
                </div>
              </Command.Empty>
            ...
            {isEmpty(query) &&
              (isEmpty(recentSearches) ? (
                <div className={slots.emptyWrapper()}>
                  <p className="text-default-400">Nenhuma pesquisa recente</p>
                </div>
              ) : (
                recentSearches &&
