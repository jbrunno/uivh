...
export const useSandpack = ({
   ...
   */
  // const vhsysuiComponents = useMemo(
  //   () =>
  //     Object.values(getVhsysUIComponents(sortedFiles) || {}).flatMap((e) =>
  //       e.split(",").map((name) => name.replace(/"/g, "")),
  //     ),
  //   [sortedFiles],
  // );

  // const hasComponents = !isEmpty(vhsysuiComponents);
  ...
  //   if (hasComponents) {
  //     let deps = {
  //       "@vhsys-ui/theme": "dev-v2",
  //       "@vhsys-ui/system": "dev-v2",
  //     };

  //     vhsysuiComponents.forEach((component) => {
  //       deps = {
  //         ...deps,
  //         [`@vhsys-ui/${component}`]: "dev-v2",
  //       };
  //     });
  ...
  //   return {
  //     ...deps,
  //     "@vhsys-ui/react": "dev-v2",
  //   };
  // }, [hasComponents, vhsysuiComponents, component]);

  // const tailwindConfigFile = useMemo(
  //   () => (hasComponents ? updateTailwindConfig(tailwindConfig, vhsysuiComponents) : tailwindConfig),
  //   [tailwindConfig, vhsysuiComponents],
  // );
