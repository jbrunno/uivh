...
/**
 * The VhsysUI config.
 * @see https://vhsys.com.br/docs/customization/customize-theme
 */
export type VhsysUIPluginConfig = {
  /**
  ...
  prefix?: string;
  /**
   * If true, the common vhsysui colors (e.g. "blue", "green", "purple") will not be extended on the theme.
   * @default false
   */
