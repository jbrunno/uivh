import type {PaginationSlots, PaginationVariantProps, SlotsToClasses} from "@vhsys-ui/theme";
import type {Timer} from "@vhsys-ui/shared-utils";
...
import {
  ...
  PaginationItemValue,
  PaginationItemType,
} from "@vhsys-ui/use-pagination";
import {useEffect, useRef, useMemo} from "react";
import {mapPropsVariants} from "@vhsys-ui/system";
import {usePagination as useBasePagination} from "@vhsys-ui/use-pagination";
import scrollIntoView from "scroll-into-view-if-needed";
import {pagination} from "@vhsys-ui/theme";
...
interface Props extends Omit<HTMLVhsysUIProps<"nav">, "onChange"> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<HTMLElement>;
