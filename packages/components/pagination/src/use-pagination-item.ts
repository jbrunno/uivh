...
import {PaginationItemValue} from "@vhsys-ui/use-pagination";
...
import {filterDOMProps, useDOMRef} from "@vhsys-ui/react-utils";
import {useHover} from "@react-aria/interactions";
import {useFocusRing} from "@react-aria/focus";

interface Props extends Omit<HTMLVhsysUIProps<"li">, "onClick"> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<HTMLElement>;
   ...
   */
  onClick?: HTMLVhsysUIProps<"li">["onClick"];
  /**
   * Callback fired when the item is clicked.
   * @param e PressEvent
   */
