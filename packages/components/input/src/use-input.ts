import type {InputVariantProps, SlotsToClasses, InputSlots} from "@vhsys-ui/theme";
...
import {clsx, dataAttr, safeAriaLabel} from "@vhsys-ui/shared-utils";
...
export interface Props<T extends HTMLInputElement | HTMLTextAreaElement = HTMLInputElement>
  extends Omit<HTMLVhsysUIProps<"input">, keyof InputVariantProps> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<T>;
