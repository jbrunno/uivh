import type {BadgeSlots, BadgeVariantProps, SlotsToClasses} from "@vhsys-ui/theme";
import type {ReactNode} from "react";
import type {HTMLVhsysUIProps, PropGetter} from "@vhsys-ui/system-rsc";

import {badge} from "@vhsys-ui/theme";
...
interface Props extends HTMLVhsysUIProps<"span", "content"> {
  /**
   * Ref to the DOM node.
   */
