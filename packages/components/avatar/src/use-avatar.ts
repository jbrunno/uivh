import type {AvatarSlots, AvatarVariantProps, SlotsToClasses} from "@vhsys-ui/theme";
...
import {clsx, safeText, dataAttr} from "@vhsys-ui/shared-utils";
import {ReactRef} from "@vhsys-ui/react-utils";
import {useFocusRing} from "@react-aria/focus";
import {useMemo, useCallback} from "react";
import {useImage} from "@vhsys-ui/use-image";
import {useHover} from "@react-aria/interactions";

import {useAvatarGroupContext} from "./avatar-group-context";

interface Props extends HTMLVhsysUIProps<"span"> {
  /**
   * Ref to the DOM node.
   */
