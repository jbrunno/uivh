...
import type {ReactRef} from "@vhsys-ui/react-utils";
import type {ButtonGroupVariantProps} from "@vhsys-ui/theme";

import {buttonGroup} from "@vhsys-ui/theme";
import {HTMLVhsysUIProps, PropGetter, mapPropsVariants} from "@vhsys-ui/system";
import {useDOMRef} from "@vhsys-ui/react-utils";
import {useMemo, useCallback} from "react";
interface Props extends HTMLVhsysUIProps, ButtonGroupVariantProps {
  /**
   * Ref to the DOM node.
   */
