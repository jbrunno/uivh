import type {BreadcrumbsVariantProps, SlotsToClasses, BreadcrumbsSlots} from "@vhsys-ui/theme";
...
import {breadcrumbs} from "@vhsys-ui/theme";
import {filterDOMProps, pickChildren, ReactRef, useDOMRef} from "@vhsys-ui/react-utils";
...
interface Props extends HTMLVhsysUIProps<"nav">, AriaBreadcrumbsProps {
  /**
   * Ref to the DOM node.
   */
