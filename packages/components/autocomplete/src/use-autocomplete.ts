import type {AutocompleteVariantProps, SlotsToClasses, AutocompleteSlots} from "@vhsys-ui/theme";

import {DOMAttributes, HTMLVhsysUIProps, mapPropsVariants, PropGetter} from "@vhsys-ui/system";
import {autocomplete} from "@vhsys-ui/theme";
