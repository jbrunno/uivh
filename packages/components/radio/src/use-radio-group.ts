...
import type {RadioGroupSlots, SlotsToClasses} from "@vhsys-ui/theme";

import {radioGroup} from "@vhsys-ui/theme";
...
interface Props extends Omit<HTMLVhsysUIProps<"div">, "onChange"> {
  /**
   * Ref to the DOM node.
   */
