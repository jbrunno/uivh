import type {ToggleVariantProps, ToggleSlots, SlotsToClasses} from "@vhsys-ui/theme";
...
import {toggle} from "@vhsys-ui/theme";
...
interface Props extends HTMLVhsysUIProps<"input"> {
  /**
   * Ref to the DOM node.
   */
  ref?: Ref<HTMLElement>;
