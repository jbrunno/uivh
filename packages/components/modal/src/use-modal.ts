import type {ModalVariantProps, SlotsToClasses, ModalSlots} from "@vhsys-ui/theme";
import type {HTMLMotionProps} from "framer-motion";

import {AriaModalOverlayProps} from "@react-aria/overlays";
import {useAriaModalOverlay} from "@vhsys-ui/use-aria-modal-overlay";
import {useCallback, useId, useRef, useState, useMemo, ReactNode} from "react";
import {modal} from "@vhsys-ui/theme";
...
interface Props extends HTMLVhsysUIProps<"section"> {
  /**
   * Ref to the DOM node.
   */
