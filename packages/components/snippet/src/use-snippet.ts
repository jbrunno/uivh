import type {SnippetVariantProps, SnippetSlots, SlotsToClasses} from "@vhsys-ui/theme";

import {snippet} from "@vhsys-ui/theme";
...
import {useClipboard} from "@vhsys-ui/use-clipboard";
import {useFocusRing} from "@react-aria/focus";
import {useMemo, useCallback, ReactElement, useRef} from "react";
import {TooltipProps} from "@vhsys-ui/tooltip";
import {ButtonProps} from "@vhsys-ui/button";
export interface UseSnippetProps extends Omit<HTMLVhsysUIProps, "onCopy">, SnippetVariantProps {
  /**
   * Ref to the DOM node.
   */
  ...
  /**
   * Tooltip props.
   * @see [Tooltip](https://vhsys.com.br/components/tooltip) for more details.
   * @default {
   *  offset: 15,
   *  delay: 1000,
  ...
  /**
   * Copy button props.
   * @see [Button](https://vhsys.com.br/components/button) for more details.
   * @default {
   *   isDisabled: disableCopy,
   *   onPress: onCopy
   *   size:"sm",
