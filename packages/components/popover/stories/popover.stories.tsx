...
import {popover, ButtonVariantProps} from "@vhsys-ui/theme";
import {Button} from "@vhsys-ui/button";
import {Input} from "@vhsys-ui/input";
import {Card, CardHeader, CardFooter} from "@vhsys-ui/card";
    ...
    <CardFooter className="absolute bg-black/40 bottom-0 z-10 border-t border-default-600 dark:border-default-100">
      <div className="flex flex-grow gap-2 items-center">
        <img
          ...
          src="https://vhsys.com.br/images/breathing-app-icon.jpeg"
        />
