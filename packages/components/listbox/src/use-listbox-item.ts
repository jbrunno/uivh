...
import {listboxItem} from "@vhsys-ui/theme";
import {HTMLVhsysUIProps, mapPropsVariants, PropGetter} from "@vhsys-ui/system";
import {useFocusRing} from "@react-aria/focus";
import {Node} from "@react-types/shared";
import {filterDOMProps} from "@vhsys-ui/react-utils";
import {clsx, dataAttr, removeEvents} from "@vhsys-ui/shared-utils";
import {useOption} from "@react-aria/listbox";
import {mergeProps} from "@react-aria/utils";
import {useHover} from "@react-aria/interactions";
import {usePress} from "@vhsys-ui/use-aria-press";
import {useIsMobile} from "@vhsys-ui/use-is-mobile";
...
export type UseListboxItemProps<T extends object> = Props<T> &
  Omit<HTMLVhsysUIProps<"li">, keyof Props<T>>;
