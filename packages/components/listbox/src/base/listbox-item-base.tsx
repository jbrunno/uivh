import type {ListboxItemVariantProps, ListboxItemSlots, SlotsToClasses} from "@vhsys-ui/theme";
import type {AriaOptionProps} from "@react-aria/listbox";
import type {FocusableProps, PressEvents} from "@react-types/shared";

import {BaseItem, ItemProps} from "@vhsys-ui/aria-utils";
...
interface Props<T extends object = {}> extends Omit<ItemProps<"li", T>, "children" | "title"> {
   ...
   * If you pass a function, VhsysUI will expose the current selected icon and the selected status,
