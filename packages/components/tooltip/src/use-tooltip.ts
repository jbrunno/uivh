import type {PopoverVariantProps, SlotsToClasses} from "@vhsys-ui/theme";
import type {AriaTooltipProps} from "@react-types/tooltip";
import type {OverlayTriggerProps} from "@react-types/overlays";
import type {HTMLMotionProps} from "framer-motion";
import type {OverlayOptions} from "@vhsys-ui/aria-utils";
...
import {popover} from "@vhsys-ui/theme";
import {clsx, dataAttr} from "@vhsys-ui/shared-utils";
import {ReactRef, mergeRefs} from "@vhsys-ui/react-utils";
import {createDOMRef} from "@vhsys-ui/react-utils";
import {useMemo, useRef, useCallback} from "react";
import {toReactAriaPlacement, getArrowPlacement} from "@vhsys-ui/aria-utils";
import {useSafeLayoutEffect} from "@vhsys-ui/use-safe-layout-effect";

interface Props extends Omit<HTMLVhsysUIProps, "content"> {
  /**
   * Ref to the DOM node.
   */
