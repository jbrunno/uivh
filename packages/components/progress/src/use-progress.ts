import type {ProgressVariantProps, SlotsToClasses, ProgressSlots} from "@vhsys-ui/theme";
import type {PropGetter} from "@vhsys-ui/system";
import type {AriaProgressBarProps} from "@react-types/progress";

import {HTMLVhsysUIProps, mapPropsVariants} from "@vhsys-ui/system";
import {progress} from "@vhsys-ui/theme";
import {useDOMRef} from "@vhsys-ui/react-utils";
import {clampPercentage, clsx, dataAttr} from "@vhsys-ui/shared-utils";
import {ReactRef} from "@vhsys-ui/react-utils";
import {mergeProps} from "@react-aria/utils";
import {useMemo, useCallback} from "react";
import {useIsMounted} from "@vhsys-ui/use-is-mounted";
