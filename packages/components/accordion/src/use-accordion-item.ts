...
import {accordionItem} from "@vhsys-ui/theme";
import {clsx, callAllHandlers, dataAttr} from "@vhsys-ui/shared-utils";
import {ReactRef, useDOMRef, filterDOMProps} from "@vhsys-ui/react-utils";
import {NodeWithProps} from "@vhsys-ui/aria-utils";
import {useReactAriaAccordionItem} from "@vhsys-ui/use-aria-accordion";
...
export interface Props<T extends object> extends HTMLVhsysUIProps<"div"> {
  /**
   * Ref to the DOM node.
   */
