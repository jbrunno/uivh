import type {NavbarVariantProps, SlotsToClasses, NavbarSlots} from "@vhsys-ui/theme";

import {HTMLVhsysUIProps, mapPropsVariants, PropGetter} from "@vhsys-ui/system";
import {navbar} from "@vhsys-ui/theme";
...
import {useScrollPosition} from "@vhsys-ui/use-scroll-position";
import {useControlledState} from "@react-stately/utils";
import {HTMLMotionProps} from "framer-motion";

interface Props extends HTMLVhsysUIProps<"nav"> {
  /**
   * Ref to the DOM node.
   */
