import {AriaToggleButtonProps, useAriaToggleButton} from "@vhsys-ui/use-aria-toggle-button";
...
export interface Props extends Omit<HTMLVhsysUIProps<"button">, keyof AriaToggleButtonProps> {
  /**
...
NavbarMenuToggle.displayName = "VhsysUI.NavbarMenuToggle";
