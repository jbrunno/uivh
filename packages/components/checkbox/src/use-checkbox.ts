import type {CheckboxVariantProps, CheckboxSlots, SlotsToClasses} from "@vhsys-ui/theme";
...
import {checkbox} from "@vhsys-ui/theme";
import {useHover} from "@react-aria/interactions";
import {usePress} from "@vhsys-ui/use-aria-press";
import {useFocusRing} from "@react-aria/focus";
import {chain, mergeProps} from "@react-aria/utils";
import {useFocusableRef} from "@vhsys-ui/react-utils";
import {__DEV__, warn, clsx, dataAttr, safeAriaLabel} from "@vhsys-ui/shared-utils";
import {
...
interface Props extends Omit<HTMLVhsysUIProps<"input">, keyof CheckboxVariantProps> {
  /**
   * Ref to the DOM node.
   */
