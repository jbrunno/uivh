...
import {useImage as useImageBase} from "@vhsys-ui/use-image";
import {useMemo} from "react";
type NativeImageProps = ImgHTMLAttributes<HTMLImageElement>;

interface Props extends HTMLVhsysUIProps<"img"> {
  /**
   * Ref to the DOM node.
   */
