import type {TabsVariantProps, SlotsToClasses, TabsSlots, TabsReturnType} from "@vhsys-ui/theme";

import {HTMLVhsysUIProps, mapPropsVariants, PropGetter} from "@vhsys-ui/system";
import {tabs} from "@vhsys-ui/theme";
...
import {CollectionProps} from "@vhsys-ui/aria-utils";
import {CollectionChildren} from "@react-types/shared";
import {HTMLMotionProps} from "framer-motion";

export interface Props extends Omit<HTMLVhsysUIProps, "children"> {
  /**
   * Ref to the DOM node.
   */
