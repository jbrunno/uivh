...
import {card} from "@vhsys-ui/theme";
import {Link} from "@vhsys-ui/link";
import {Button} from "@vhsys-ui/button";
import {Code} from "@vhsys-ui/code";
import {Image} from "@vhsys-ui/image";
  ...
  <Card {...args} className="p-4 max-w-md">
    <CardHeader className="flex gap-3">
      ...
      <div className="flex flex-col">
        <b className="text-lg">VhsysUI</b>
        <p className="text-default-500">vhsys.com.br</p>
      </div>
    </CardHeader>
    ...
    <CardFooter>
      <Link isExternal showAnchorIcon href="https://git.vhsys.com.br/front/frontend-core">
  ...
  <div className="max-w-[900px] gap-2 grid grid-cols-12 grid-rows-2 px-8">
    <Card {...args} className="col-span-12 sm:col-span-4">
      ...
      <img
        ...
        src="https://vhsys.com.br/images/card-example-4.jpeg"
      />
    </Card>
    <Card {...args} className="col-span-12 sm:col-span-4">
      <CardHeader className="absolute z-10 top-1 flex-col !items-start">
      ...
      <img
        alt="Card background"
        className="w-full h-full object-cover"
        src="https://vhsys.com.br/images/card-example-3.jpeg"
      />
    </Card>
    <Card {...args} className="col-span-12 sm:col-span-4">
      <CardHeader className="absolute z-10 top-1 flex-col !items-start">
      ...
      <img
        alt="Card background"
        className="w-full h-full object-cover"
        src="https://vhsys.com.br/images/card-example-2.jpeg"
      />
    </Card>
    <Card {...args} isFooterBlurred className="w-full h-[400px] col-span-12 sm:col-span-5">
      ...
      <img
        ...
        src="https://vhsys.com.br/images/card-example-6.jpeg"
      />
    ...
    <Card {...args} isFooterBlurred className="w-full h-[400px] col-span-12 sm:col-span-7">
      ...
      <img
        ...
        className="w-full h-full object-cover"
        src="https://vhsys.com.br/images/card-example-5.jpeg"
      />
        ...
        <Card {...args} key={index} isPressable onPress={() => handlePress(item)}>
          <CardBody className="p-0">
            <img
              ...
              src={"https://vhsys.com.br" + item.img}
            />
          </CardBody>
