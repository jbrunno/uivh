...
import type {SlotsToClasses, CardSlots, CardReturnType, CardVariantProps} from "@vhsys-ui/theme";
...
import {ReactRef, filterDOMProps} from "@vhsys-ui/react-utils";
import {useDOMRef} from "@vhsys-ui/react-utils";
import {useRipple} from "@vhsys-ui/ripple";

export interface Props extends HTMLVhsysUIProps<"div"> {
  /**
   * Ref to the DOM node.
   */
