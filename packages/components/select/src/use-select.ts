import type {SelectSlots, SelectVariantProps, SlotsToClasses} from "@vhsys-ui/theme";
import type {HiddenSelectProps} from "./hidden-select";

import {DOMAttributes, HTMLVhsysUIProps, mapPropsVariants, PropGetter} from "@vhsys-ui/system";
import {select} from "@vhsys-ui/theme";
import {ReactRef, useDOMRef, filterDOMProps} from "@vhsys-ui/react-utils";
import {useMemo, useCallback, useRef, Key, ReactNode, useEffect} from "react";
import {ListboxProps} from "@vhsys-ui/listbox";
import {useAriaButton} from "@vhsys-ui/use-aria-button";
import {useFocusRing} from "@react-aria/focus";
import {clsx, dataAttr} from "@vhsys-ui/shared-utils";
import {mergeProps} from "@react-aria/utils";
import {useHover} from "@react-aria/interactions";
import {PopoverProps} from "@vhsys-ui/popover";
import {ScrollShadowProps} from "@vhsys-ui/scroll-shadow";
import {
  MultiSelectProps,
  useMultiSelect,
  useMultiSelectState,
} from "@vhsys-ui/use-aria-multiselect";
import {SpinnerProps} from "@vhsys-ui/spinner";
...
interface Props<T> extends Omit<HTMLVhsysUIProps<"select">, keyof SelectVariantProps> {
  /**
   * Ref to the DOM node.
   */
