import type {SlotsToClasses, UserSlots} from "@vhsys-ui/theme";
import type {AvatarProps} from "@vhsys-ui/avatar";

import {ReactNode, useMemo, useCallback} from "react";
import {useFocusRing} from "@react-aria/focus";
import {HTMLVhsysUIProps, PropGetter} from "@vhsys-ui/system";
import {user} from "@vhsys-ui/theme";
import {clsx, dataAttr} from "@vhsys-ui/shared-utils";
import {filterDOMProps, ReactRef} from "@vhsys-ui/react-utils";
...
interface Props {
   ...
   * @see https://vhsys.com.br/docs/components/avatar
   */
...
export type UseUserProps = Props & Omit<HTMLVhsysUIProps<"div">, "children">;
