...
import {menu, MenuVariantProps, SlotsToClasses, MenuSlots} from "@vhsys-ui/theme";
import {TreeState, useTreeState} from "@react-stately/tree";
import {ReactRef, filterDOMProps, useDOMRef} from "@vhsys-ui/react-utils";
...
export type UseMenuProps<T = object> = Props<T> &
  Omit<HTMLVhsysUIProps<"ul">, keyof AriaMenuProps<T>> &
  AriaMenuProps<T> &
  MenuVariantProps;
